/**
 * Alpine.js component pour le formulaire PlaceRequest
 *
 * Responsabilités :
 * - Intercepter la soumission du formulaire
 * - Obtenir le token reCAPTCHA via window.recaptcha.getToken('place_request_submit')
    ...
    return {
        ...
        async handleSubmit() {
            try {
                ...
                const token = await window.recaptcha.getToken('place_request_submit');
