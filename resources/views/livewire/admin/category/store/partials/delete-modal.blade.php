                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-blue-700">
                                                <p>
                                                    Cette catégorie est actuellement associée à <strong>{{ $associatedPlacesCount }}</strong> lieu{{ $associatedPlacesCount > 1 ? 'x' : '' }}.
                                                </p>
                                                <p class="mt-2">
                                                    ℹ️ <strong>Note :</strong> Les catégories sont uniquement destinées à l'organisation interne des administrateurs. Leur suppression n'affecte pas la visibilité des lieux pour les visiteurs.
                                                </p>
                                                <p class="mt-2">
                                                    La catégorie sera automatiquement dissociée de tous ces lieux lors de la suppression.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
