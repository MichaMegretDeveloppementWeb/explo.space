...
class AboutSeoStrategy implements SeoStrategyInterface
{
    ...
    public function getHreflangData(): array
    {
        ...
        $hreflangs[] = [
            'hreflang' => 'x-default',
            'href' => localRoute('about', [], config('locales.default', 'fr')),
        ];
