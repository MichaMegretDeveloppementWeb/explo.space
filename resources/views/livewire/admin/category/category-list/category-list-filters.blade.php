...
<div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white">
        <div class="p-4">
            {{-- Ligne unique de filtres avec séparateur vertical --}}
            <div class="flex flex-col lg:flex-row lg:items-start gap-4 lg:gap-0 lg:divide-x lg:divide-gray-200">
                ...
                {{-- Section 2: Statut (flex-1 pour étalement) --}}
                <div class="lg:pl-4 flex-1">
                    <label for="activeFilter" class="block text-xs font-medium text-gray-700 mb-1.5">
                        Statut
                    </label>
