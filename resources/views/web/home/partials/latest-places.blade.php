    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center items-stretch gap-6 sm:gap-8 max-w-6xl mx-auto">
            @forelse($latestPlaces as $place)
                ...
                @endif
            @empty
                <!-- Fallback si aucun lieu récent -->
                <div class="col-span-full text-center py-12">
                    <p class="text-gray-500 text-lg">{{ __('web/pages/home.latest_places.no_places') }}</p>
                </div>
            @endforelse
        </div>
    </div>
