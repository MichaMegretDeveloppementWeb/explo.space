    ...
    <div class="mb-4 flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-3">
        <div class="flex items-center gap-4">
            <div class="text-sm text-gray-600">
                <span class="font-semibold text-gray-900">{{ $tags->total() }}</span>
                <span class="text-gray-500">{{ $tags->total() > 1 ? 'tags' : 'tag' }}</span>
            </div>
            ...
            @if($tags->total() > 0)
                <div class="hidden flex-row items-center gap-2 md:flex">
                    ...
                    <div class="text-xs text-gray-500">
                        {{ $tags->firstItem() }}-{{ $tags->lastItem() }} sur {{ $tags->total() }}
                    </div>
                </div>
            @endif
        </div>
            ...
            <div wire:loading.flex class="absolute inset-0 z-10 flex items-center justify-center bg-white/50 backdrop-blur-sm">
                <div class="flex flex-col items-center gap-3">
                    ...
                    <div class="text-center">
                        <p class="text-sm font-medium text-gray-900">Chargement des tags</p>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-600">
                                            {{ $tag->places_count }} {{ $tag->places_count > 1 ? 'lieux' : 'lieu' }}
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-sm font-medium text-gray-900 mb-1">Aucun tag trouvé</h3>
