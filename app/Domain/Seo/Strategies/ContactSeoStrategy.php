...
class ContactSeoStrategy implements SeoStrategyInterface
{
    ...
    public function getHreflangData(): array
    {
        ...
        $hreflangs[] = [
            'hreflang' => 'x-default',
            'href' => localRoute('contact', [], config('locales.default', 'fr')),
        ];
