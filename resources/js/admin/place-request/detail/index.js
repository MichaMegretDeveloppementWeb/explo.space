...
/**
 * Point d'entrée Vite pour la page de détail des propositions de lieux
 *
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mapContainer = document.getElementById('place-request-location-preview');
    ...
    if (mapContainer) {
        ...
        if (!isNaN(lat) && !isNaN(lng)) {
            new LocationPreview('place-request-location-preview', lat, lng);
        } else {
