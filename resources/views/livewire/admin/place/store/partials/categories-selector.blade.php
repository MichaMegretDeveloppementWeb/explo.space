<div>
    <label class="block text-sm font-medium text-gray-900 mb-3">
        Catégories
        <span class="text-gray-500 font-normal">(usage interne admin)</span>
    </label>
    ...
    <div class="space-y-2 max-h-64 overflow-y-auto border border-gray-200 rounded-lg p-4">
        ...
        @empty
            <div class="text-center py-6">
                ...
                <p class="mt-2 text-sm text-gray-500">Aucune catégorie disponible</p>
                <p class="mt-1 text-xs text-gray-400">Les catégories doivent être créées au préalable</p>
            </div>
        @endforelse
    </div>
    ...
    <p class="mt-1.5 text-xs text-gray-500">
        Les catégories sont utilisées en interne pour organiser les lieux (non visibles publiquement)
    </p>
</div>
