...
use App\Livewire\Admin\Tag\TagList\Concerns\ManagesLoadData;
...
class TagListTable extends Component
{
    ...
    {
        return view('livewire.admin.tag.tag-list.tag-list-table', [
            'tags' => $this->loadTags(),
            'locale' => $this->locale,
        ]);
    }
     ...
     */
    #[On('filters:updated')]
    public function updateFiltersFromEvent(string $search, string $activeFilter, string $locale): void
    {
        $this->search = $search;
