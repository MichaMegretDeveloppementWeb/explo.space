    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 sm:mb-16">
            ...
            <p class="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl sm:max-w-3xl mx-auto px-2 sm:px-0">
                Decouvrir les lieux spatiaux n'a jamais ete aussi simple
            </p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 relative">
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Recherchez</h3>
                <p class="text-sm sm:text-base text-gray-600 px-2 sm:px-0">
                    Choisissez votre mode de recherche : autour de votre position ou dans le monde entier.
                </p>
            </div>
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Explorez</h3>
                <p class="text-sm sm:text-base text-gray-600 px-2 sm:px-0">
                    Parcourez les resultats sur une carte interactive et decouvrez les lieux qui vous interessent.
                </p>
            </div>
            ...
            <div class="text-center sm:col-span-2 md:col-span-1">
                ...
                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Decouvrez</h3>
                <p class="text-sm sm:text-base text-gray-600 px-2 sm:px-0 sm:max-w-sm md:max-w-none mx-auto">
                    Consultez les fiches detaillees avec photos, informations historiques et conseils pratiques.
                </p>
            </div>
        </div>
    </div>
