...
class LegalSeoStrategy implements SeoStrategyInterface
{
    ...
    public function getHreflangData(): array
    {
        ...
        $hreflangs[] = [
            'hreflang' => 'x-default',
            'href' => localRoute('legal', [], config('locales.default', 'fr')),
        ];
    ...
    private function buildWebPageSchema(): array
    {
        return [
            ...
            'about' => [
                ...
                'description' => 'Legal notice and terms of '.config('app.name'),
            ],
        ];
    }
