...
<section class="py-12 sm:py-16 md:py-20 lg:pb-32 bg-gradient-to-br from-slate-50 to-blue-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            ...
            <div class="text-center self-stretch">
                <div class="bg-white rounded-xl h-full sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-shadow">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md sm:shadow-lg relative" style="box-shadow: 0 10px 25px -3px rgb(59 130 246 / 0.3), 0 4px 6px -2px rgb(6 182 212 / 0.2);">
            ...
            <div class="text-center self-stretch">
                <div class="bg-white rounded-xl h-full sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-shadow">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md sm:shadow-lg relative" style="box-shadow: 0 10px 25px -3px rgb(168 85 247 / 0.3), 0 4px 6px -2px rgb(236 72 153 / 0.2);">
                        <!-- Gradient background for icon -->
            ...
            <div class="text-center self-stretch">
                <div class="bg-white rounded-xl h-full sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-shadow">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md sm:shadow-lg relative" style="box-shadow: 0 10px 25px -3px rgb(34 197 94 / 0.3), 0 4px 6px -2px rgb(13 148 136 / 0.2);">
                        <!-- Gradient background for icon -->
            ...
            <div class="text-center self-stretch">
                <div class="bg-white rounded-xl h-full sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-shadow">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md sm:shadow-lg relative" style="box-shadow: 0 10px 25px -3px rgb(249 115 22 / 0.3), 0 4px 6px -2px rgb(220 38 38 / 0.2);">
                        <!-- Gradient background for icon -->
