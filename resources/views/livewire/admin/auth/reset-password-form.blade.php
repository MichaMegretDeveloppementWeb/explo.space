    ...
    <form wire:submit="resetPassword" class="space-y-5">
        ...
        <div>
            ...
            <input
                ...
                id="email"
                readonly
                class="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-lg bg-gray-50 text-gray-600 cursor-not-allowed"
            >
            @error('email')
        ...
        <div>
            ...
            <input
                ...
                autocomplete="new-password"
                class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                placeholder="••••••••"
            >
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <p class="text-sm text-blue-700 flex items-start">
                ...
                <span><strong>Conseil de sécurité :</strong> Utilisez au minimum 8 caractères avec des lettres, des chiffres et des symboles.</span>
            </p>
        </div>
