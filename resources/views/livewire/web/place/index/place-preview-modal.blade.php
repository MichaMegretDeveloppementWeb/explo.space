        ...
        <div @click.stop
            ...
            @if($place)
                ...
                <div class="p-6 space-y-4">
                    {{-- Titre --}}
                    <h2 class="text-xl sm:text-2xl font-semibold text-gray-900 leading-tight flex items-center gap-2">
                        @if($place->isFeatured)
                            <svg class="w-5 h-5 text-purple-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" title="{{ __('web/common.featured_place') }}">
