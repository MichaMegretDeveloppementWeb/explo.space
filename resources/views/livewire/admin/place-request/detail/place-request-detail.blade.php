<div>
    ...
    {{-- Header sticky --}}
    @include('admin.place-request.detail.partials.header', ['placeRequest' => $placeRequest])

    {{-- Content --}}
    <div class="max-w-7xl mx-auto mt-6">
        <div class="space-y-6">
            {{-- Informations générales --}}
            @include('admin.place-request.detail.partials.general-info', ['placeRequest' => $placeRequest])

            {{-- Grid 2 colonnes pour Localisation + Workflow --}}
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {{-- Localisation --}}
                @include('admin.place-request.detail.partials.location', ['placeRequest' => $placeRequest])

                {{-- Traçabilité & Workflow --}}
                @include('admin.place-request.detail.partials.workflow', ['placeRequest' => $placeRequest])
            </div>

            {{-- Photos --}}
            @include('admin.place-request.detail.partials.photos', [
                ...
                <div class="px-4 md:px-6 py-5">
                    <div class="space-y-4">
                        <p class="text-sm text-gray-600">
                            Êtes-vous certain de vouloir refuser cette proposition&nbsp;? Vous pourrez toujours l'accepter ultérieurement si nécessaire.
                        </p>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Expliquez brièvement pourquoi cette proposition ne peut être acceptée..."></textarea>
