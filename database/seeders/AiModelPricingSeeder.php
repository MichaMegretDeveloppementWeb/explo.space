...
class AiModelPricingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $models = [
            ...
            ['provider' => 'anthropic', 'model' => 'claude-haiku-4-5-20251001', 'price_input_per_million' => 1.00, 'price_output_per_million' => 5.00],

            // Google Gemini
            ['provider' => 'gemini', 'model' => 'gemini-3-flash-preview', 'price_input_per_million' => 0.50, 'price_output_per_million' => 3.00],
        ];
